export function NoteCard() {
    ...
    <button className="rounded-md text-left bg-slate-800 p-5 space-y-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 outline-none">
        ...
        <p className="text-sm leading-6 text-slate-400">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores quia vitae, dignissimos reprehenderit perspiciatis voluptate, maiores aliquid libero aut ipsam dolores sapiente impedit saepe neque sunt rem architecto. Sequi, error.
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores quia vitae, dignissimos reprehenderit perspiciatis voluptate, maiores aliquid libero aut ipsam dolores sapiente impedit saepe neque sunt rem architecto. Sequi, error.
          </p>
